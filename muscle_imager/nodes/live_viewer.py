...
class MainWindow(TemplateBaseClass):  
	...
	def __init__(self):
		...
		rospy.logwarn("live_viewer pid: " + str(os.getpid()))
	...
	def muscle_signal_callback(self,msg):
		...
		#rospy.logwarn("dt muscle_signal_callback: " + str(time.time()-t_start))
	...
	def frame_count_callback(self,msg):
		# Update viewer at roughly 25 fps
	...
	def image_callback(self,rosimg):
		...
		#rospy.logwarn("dt image_callback: " + str(time.time()-self.t_last))
		#self.t_last = time.time()
	...
	def qt_tick(self):
		...
		#rospy.logwarn("dt qt_tick: " + str(time.time()-self.t_last))
		#self.t_last = time.time()
